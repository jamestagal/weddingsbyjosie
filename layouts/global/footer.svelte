      ...
      <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-5 widget-area">
          <div class="widget widget_text clearfix">
            <h3 class="widget-title">Weddings by Josie</h3>
            <div class="textwidget widget-text">
              A registered Canberra based marriage celebrant. I perform Wedding
              ceremonies including same-sex marriages or a Naming Day or a
